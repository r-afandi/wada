	...
	class SP_WCS_Options extends SP_WCS_Abstract {
		...
		public function add_options_html() {
			...
			if ( $show_buttons ) {
				...
				echo '<input type="submit" name="' . esc_attr( $this->unique ) . '[_nonce][save]" class="button button-primary spf-save' . esc_attr( $ajax_class ) . '" value="' . esc_html__( 'Save Settings', 'woo-category-slider' ) . '" data-save="' . esc_html__( 'Saving...', 'woo-category-slider' ) . '">';
				echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="spf_transient[reset_section]" class="button button-secondary spf-reset-section spf-confirm" value="' . esc_html__( 'Reset Tab', 'woo-category-slider' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset all the settings of this tab?', 'woo-category-slider' ) . '">' : '';
