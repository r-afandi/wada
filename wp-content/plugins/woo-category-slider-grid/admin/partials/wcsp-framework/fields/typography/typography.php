	...
	class SP_WCS_Field_typography extends SP_WCS_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
				...
				echo '<option value="">' . ( ! $this->chosen ? esc_html__( 'Default', 'woo-category-slider' ) : '' ) . '</option>'; // phpcs:ignore
			...
			if ( ! empty( $args['subset'] ) ) {
				...
				echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'woo-category-slider' ), $args['multi_subset'] ); // phpcs:ignore
				echo '</div>';
			}
