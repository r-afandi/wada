	...
	class SP_WCS_Field_dimensions_advanced extends SP_WCS_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['style'] ) ) {
				...
				echo '</select>';
				echo $args['unit'] ? '<span style=" background-color: #d4d4d4;padding: 2px 4px;font-size: 8px;border-radius: 2px;height: 11px;line-height: 30px;opacity: .7;margin-left: 5px">PRO</span>' : '';
				echo '</div>';
			}
