...
class SP_WCS_Tools {
	...
	public static function tools( $prefix ) {
		...
		SP_WCS::createOptions(
			$prefix,
			array(
				'menu_title'       => __( 'Tools', 'woo-category-slider' ),
				...
				'theme'            => 'light',
				'framework_title'  => __( 'Tools', 'woo-category-slider' ),
		...
		SP_WCS::createSection(
			$prefix,
			array(
				'title'  => __( 'Export', 'woo-category-slider' ),
				'fields' => array(
					array(
						'id'       => 'wcsp_what_export',
						'type'     => 'radio',
						'class'    => 'wcsp_what_export',
						'title'    => __( 'Choose What To Export', 'woo-category-slider' ),
						'multiple' => false,
						'options'  => array(
							'all_shortcodes'      => __( 'All Sliders (Shortcodes)', 'woo-category-slider' ),
							'selected_shortcodes' => __( 'Selected Slider (Shortcode)', 'woo-category-slider' ),
						),
					...
					array(
						...
						'sortable'    => false,
						'multiple'    => true,
						'placeholder' => __( 'Choose slider(s)', 'woo-category-slider' ),
						'query_args'  => array(
							'posts_per_page' => -1,
						),
		...
		SP_WCS::createSection(
			$prefix,
			array(
				'title'  => __( 'Import', 'woo-category-slider' ),
				'fields' => array(
					array(
						'class' => 'wcsp_import',
						'type'  => 'custom_import',
						'title' => __( 'Import JSON File To Upload', 'woo-category-slider' ),
					),
				),
			)
		);
