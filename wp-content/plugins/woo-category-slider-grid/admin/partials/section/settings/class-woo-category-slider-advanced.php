			...
			array(
				...
				'fields' => array(
					array(
						...
						'title_help' => __( 'Check this box if you would like Category Slider for WooCommerce to completely remove all of its data when the plugin is deleted.', 'woo-category-slider' ),
						'default'    => false,
					),
					array(
						'type'    => 'subheading',
