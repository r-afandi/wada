			...
			array(
				...
				'fields' => array(
					...
					array(
						'id'       => 'wcsp_cat_zoom',
						'type'     => 'select',
						'title'    => __( 'Zoom', 'woo-category-slider' ),
						'subtitle' => __( 'Set a zoom effect for thumbnail.', 'woo-category-slider' ),
						'options'  => array(
							'none'     => __( 'None', 'woo-category-slider' ),
							'zoom-in'  => __( 'Zoom In (Pro)', 'woo-category-slider' ),
							'zoom-out' => __( 'Zoom Out (Pro)', 'woo-category-slider' ),
						),
						'default'  => 'none',
					),
					...
					array(
						...
						'type'     => 'select',
						'title'    => __( 'Image Mode', 'woo-category-slider' ),
						'subtitle' => __( 'Set a mode for category thumbnail or image.', 'woo-category-slider' ),
						'options'  => array(
							'none'            => __( 'Normal', 'woo-category-slider' ),
							'norman-on-hover' => __( 'Grayscale and normal on hover (Pro)', 'woo-category-slider' ),
							'on-hover'        => __( 'Grayscale on Hover (Pro)', 'woo-category-slider' ),
							'always'          => __( 'Always grayscale (Pro)', 'woo-category-slider' ),
						),
						'default'  => 'none',
					),
				), // End of fields array.
