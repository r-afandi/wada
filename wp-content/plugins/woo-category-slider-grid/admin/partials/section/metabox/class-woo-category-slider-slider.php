			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle'   => __( 'Enable/Disable auto play.', 'woo-category-slider' ),
					...
					array(
						...
						'subtitle'   => __( 'Enable/Disable slider pause on hover.', 'woo-category-slider' ),
						'text_on'    => __( 'Enabled', 'woo-category-slider' ),
						'text_off'   => __( 'Disabled', 'woo-category-slider' ),
						'text_width' => 94,
						'default'    => true,
					...
					array(
						...
						'subtitle'   => __( 'Enable/Disable infinite loop mode.', 'woo-category-slider' ),
						'text_on'    => __( 'Enabled', 'woo-category-slider' ),
						'text_off'   => __( 'Disabled', 'woo-category-slider' ),
						'text_width' => 94,
						'default'    => true,
					...
					array(
						...
						'subtitle'   => __( 'Enable/Disable touch swipe.', 'woo-category-slider' ),
						'text_on'    => __( 'Enabled', 'woo-category-slider' ),
						'text_off'   => __( 'Disabled', 'woo-category-slider' ),
						'text_width' => 94,
						'default'    => true,
					...
					array(
						...
						'subtitle'   => __( 'Enable/Disable mousewheel control.', 'woo-category-slider' ),
						'text_on'    => __( 'Enabled', 'woo-category-slider' ),
						'text_off'   => __( 'Disabled', 'woo-category-slider' ),
						'text_width' => 94,
						'default'    => false,
					...
					array(
						...
						'subtitle'   => __( 'Enable/Disable mouse draggable.', 'woo-category-slider' ),
						'text_on'    => __( 'Enabled', 'woo-category-slider' ),
						'text_off'   => __( 'Disabled', 'woo-category-slider' ),
						'text_width' => 94,
						'default'    => false,
					...
					array(
						...
						'subtitle'   => __( 'Enable/Disable auto height.', 'woo-category-slider' ),
						'text_on'    => __( 'Enabled', 'woo-category-slider' ),
						'text_off'   => __( 'Disabled', 'woo-category-slider' ),
						'text_width' => 94,
						'default'    => true,
