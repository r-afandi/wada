			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle'   => __( 'Select category(s). Leave it empty to show all level of categories', 'woo-category-slider' ),
						'desc'       => __( 'To display Parent with <strong>Child, Grand Child, Great-grand Child</strong>, <a href="https://shapedplugin.com/plugin/woocommerce-category-slider-pro/?ref=115" target="_blank"><b>Upgrade To Pro!</b></a>', 'woo-category-slider' ),
					...
					array(
						...
						'title'       => __( 'Display Type', 'woo-category-slider' ),
						...
						'options'     => array(
							'individualize_each' => array(
								...
								'option_name' => __( 'Individualize Each', 'woo-category-slider' ),
								'pro_only'    => true,
							),
							'under_parent'       => array(
								'image'       => SP_WCS_URL . 'admin/img/child-under-parent.svg',
								'option_name' => __( 'Child Under Parent', 'woo-category-slider' ),
								'pro_only'    => true,
							),
						),
						'dependency'  => array( 'wcsp_child_categories', '==', 'parent_and_child' ),
					...
					array(
						...
						'type'       => 'checkbox',
						'inline'     => true,
						'title'      => __( 'Exclude Level(s)', 'woo-category-slider' ),
						'subtitle'   => __( 'Exclude different level of categories.', 'woo-category-slider' ),
						'options'    => array(
							'parent'           => __( 'Parent (Pro)', 'woo-category-slider' ),
							'child'            => __( 'Child (Pro)', 'woo-category-slider' ),
							'grandchild'       => __( 'Grand Child (Pro)', 'woo-category-slider' ),
							'great_grandchild' => __( 'Great-grand Child (Pro)', 'woo-category-slider' ),
						),
						'dependency' => array( 'wcsp_child_categories', '==', 'parent_and_child' ),
					),
					array(
					...
					array(
						...
						'options'  => array(
							...
							'title'      => __( 'Name', 'woo-category-slider' ),
