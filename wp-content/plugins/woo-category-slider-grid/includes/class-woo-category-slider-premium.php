...
class Woo_Category_Slider_Premium {
	 ...
	 * Happy users.
	 *
	 * @param boolean $username happy users name.
	 * @param array   $args users args.
	 * @return array
	 */
				...
				<div class="row">
					<div class="sp-wcsp-col-xl-6">
						<div class="sp-wcsp-banner-content">
							<h2 class="sp-wcsp-font-30 main-color sp-wcsp-font-weight-500"><?php esc_html_e( 'Upgrade To WooCommerce Category Slider Pro', 'woo-category-slider' ); ?></h2>
			...
			<div class="sp-wcsp-container">
				...
				<div class="video-area text-center">
					...
					<div class="video-button">
						<a class="js-video-button" href="#" data-channel="youtube" data-video-url="//www.youtube.com/embed/qk_uEaYdIFo">
