...
class Woo_Category_Slider_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Woo Category Slider', 'woo-category-slider' ),
			array(
	...
	public function form( $instance ) {
		...
		if ( count( $shortcodes ) > 0 ) {
			...
			echo sprintf( '<p><label for="%1$s">%2$s</label>', esc_attr( $this->get_field_id( 'title' ) ), esc_html( __( 'Title:', 'woo-category-slider' ) ) );
			...
			echo sprintf( '<p><label>%s</label>', esc_html( __( 'Shortcode:', 'woo-category-slider' ) ) );
			...
			echo sprintf(
				...
				esc_html__( 'You did not generate any slider yet.', 'woo-category-slider' ),
				esc_html__( 'to generate a new slider now.', 'woo-category-slider' ),
				esc_html__( 'click here', 'woo-category-slider' )
			);
		}
	}
