...
class Woo_Category_Slider_Shortcode {
	...
	public static function sp_wcsp_html_show( $post_id, $shortcode_meta, $title ) {
		...
		$space_between_cat    = isset( $shortcode_meta['wcsp_space_between_cat'] ) && ! empty( $shortcode_meta['wcsp_space_between_cat']['all'] ) ? $shortcode_meta['wcsp_space_between_cat']['all'] : '0';
