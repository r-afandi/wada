...
if ( ! class_exists( 'WPL_WCS_Shortcode_Render' ) ) {
	...
	class WPL_WCS_Shortcode_Render {
		 ...
		 * Shortcode render.
		 *
		 * @param array $attributes sortcode attributes.
		 * @return string
		 * @since 1.0
		 */
		public function shortcode_render( $attributes ) {
			...
			$auto_play                     = ( isset( $shortcode_data['auto_play'] ) && $shortcode_data['auto_play'] ? 'true' : 'false' );
			$auto_play_speed               = ( isset( $shortcode_data['auto_play_speed'] ) ? $shortcode_data['auto_play_speed'] : '' );
			$swipe                         = ( isset( $shortcode_data['swipe'] ) && $shortcode_data['swipe'] ? 'true' : 'false' );
			$mouse_draggable               = ( isset( $shortcode_data['mouse_draggable'] ) && $shortcode_data['mouse_draggable'] ? 'true' : 'false' );
			$pagination                    = ( isset( $shortcode_data['pagination'] ) && $shortcode_data['pagination'] ? 'true' : 'false' );
			$navigation                    = ( isset( $shortcode_data['navigation'] ) && $shortcode_data['navigation'] ? 'true' : 'false' );
			$rtl                           = ( isset( $shortcode_data['rtl'] ) && $shortcode_data['rtl'] ? 'true' : 'false' );
			$pause_on_hover                = ( isset( $shortcode_data['pause_on_hover'] ) && $shortcode_data['pause_on_hover'] ? 'true' : 'false' );
			$slider_title                  = ( isset( $shortcode_data['slider_title'] ) && $shortcode_data['slider_title'] ? 'true' : 'false' );
			$cat_name                      = ( isset( $shortcode_data['cat_name'] ) && $shortcode_data['cat_name'] ? 'true' : 'false' );
			$product_count                 = ( isset( $shortcode_data['product_count'] ) && $shortcode_data['product_count'] ? 'true' : 'false' );
			$shop_now                      = ( isset( $shortcode_data['shop_now'] ) && $shortcode_data['shop_now'] ? 'true' : 'false' );
			$hide_empty_cat                = ( isset( $shortcode_data['hide_empty_cat'] ) && $shortcode_data['hide_empty_cat'] ? '1' : '0' );
			$include_child_cat             = ( isset( $shortcode_data['include_child_cat'] ) && $shortcode_data['include_child_cat'] ? 'true' : 'false' );
			$cat_image                     = ( isset( $shortcode_data['cat_image'] ) && $shortcode_data['cat_image'] ? 'true' : 'false' );
