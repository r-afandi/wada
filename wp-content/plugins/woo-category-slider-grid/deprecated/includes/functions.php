...
class WPL_WCS_Functions {
	 ...
	 * @return void
	 */
	public function wpl_wcs_admin_banner() {
		...
		<div class="wpl-wcs-framework wpl-wcs-banner-area">
			<div class="wpl-wcs-banner">
				...
				<div class="wpl-wcs-short-links">
					<a href="https://shapedplugin.com/support/" target="_blank"><span><i class="fa fa-question"></i></span>Help</a>
				</div>
			</div>
		</div>
			<?php
